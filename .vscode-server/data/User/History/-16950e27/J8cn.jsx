...
const BoasVindas = () => {
    ...
    return (
        <div class="boasvindas_page" style={{ maxWidth: "700px", margin: "0 auto" }}>        
            <div id="sobre_page" style={{ textAlign: "justify", margin: "0 auto", }}>
                ...
                <img src="https://upload.wikimedia.org/wikipedia/pt/5/55/Sheer_Heart_Attack.jpg" alt="logo" 
                    style={{ maxWidth: "200px", margin: "0 auto" }} />
                <img src="https://upload.wikimedia.org/wikipedia/pt/3/3a/Queen-The_Game.jpg" alt="logo" 
                    style={{ maxWidth: "200px", margin: "0 auto" }} />
                ...
                <h2 style={{ textAlign: "center", maxWidth:"70rem" }}>fique a vontade!!</h2>
             </div>
        </div>
    )
