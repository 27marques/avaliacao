...
const AlbumPage = () => {
    ...
    return (
        <div class="boasvindas_page">
            ...
            <iframe width="942" height="530" src="https://www.youtube.com/embed/hZdiwHHxay4?list=PLUPLEaMRcaetuKHwVEnelrmA90BoGUD8y" title="Bohemian Rhapsody (Remastered 2011)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><h1>Boas Vindas</h1>
